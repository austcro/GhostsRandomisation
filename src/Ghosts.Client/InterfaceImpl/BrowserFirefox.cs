...
{
    public class BrowserFirefox : BaseBrowserHandler, IBrowserFirefox
    {
        ...
        public bool CallHandlerAction(Timeline timeline, TimelineHandler handler)
        {
            try
            {
                EmulateBrowserFirefoxAction(handler);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private void EmulateBrowserFirefoxAction(TimelineHandler handler)
        {
